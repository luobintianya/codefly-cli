...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Codefly model for conversations (/settings)…',
  ...
  'Create a project-specific CODEFLY.md file with /init…',
  ...
  'Reload instructional context from CODEFLY.md files with /memory refresh…',
  'List the paths of the CODEFLY.md files in use with /memory list…',
  'Choose your Codefly model with /model…',
