...
interface CodeflyRespondingSpinnerProps {
  /**
...
export const CodeflyRespondingSpinner: React.FC<
  CodeflyRespondingSpinnerProps
...
interface CodeflySpinnerProps {
  spinnerType?: SpinnerName;
  altText?: string;
}

export const CodeflySpinner: React.FC<CodeflySpinnerProps> = ({
  spinnerType = 'dots',
  altText,
}) => {
  const isScreenReaderEnabled = useIsScreenReaderEnabled();
