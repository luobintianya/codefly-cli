...
import { getAdminErrorMessage } from '@codeflyai/codefly-core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload Codefly CLI agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',
