...
export const GITHUB_WORKFLOW_PATHS = [
  'codefly-dispatch/codefly-dispatch.yml',
  'codefly-assistant/codefly-invoke.yml',
  'issue-triage/codefly-triage.yml',
  'issue-triage/codefly-scheduled-triage.yml',
  'pr-review/codefly-review.yml',
];

export const GITHUB_COMMANDS_PATHS = [
  'codefly-assistant/codefly-invoke.toml',
  'issue-triage/codefly-scheduled-triage.toml',
  'issue-triage/codefly-triage.toml',
  'pr-review/codefly-review.toml',
];

const REPO_DOWNLOAD_URL =
  'https://raw.githubusercontent.com/google-github-actions/run-codefly-cli';
...
// Add Codefly CLI specific entries to .gitignore file
export async function updateGitignore(gitRepoRoot: string): Promise<void> {
  const gitignoreEntries = ['.codefly/', 'gha-creds-*.json'];
...
export const setupGithubCommand: SlashCommand = {
  ...
  action: async (
    ...
    const readmeUrl = `https://github.com/google-github-actions/run-codefly-cli/blob/${releaseTag}/README.md#quick-start`;
    ...
    return {
      ...
      toolArgs: {
        description:
          'Setting up GitHub Actions to triage issues and review PRs with Codefly.',
        command,
      },
    };
  },
