...
describe('restoreCommand', () => {
  ...
  beforeEach(async () => {
    ...
    codeflyTempDir = path.join(testRootDir, CODEFLY_DIR);
    checkpointsDir = path.join(codeflyTempDir, 'checkpoints');
    ...
    mockConfig = {
      ...
      storage: {
        ...
        getProjectTempDir: vi.fn().mockReturnValue(codeflyTempDir),
      },
