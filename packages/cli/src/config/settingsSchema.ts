      ...
      auth: {
        ...
        properties: {
          openai: {
            ...
            properties: {
              ...
              models: {
                ...
                requiresRestart: true,
                default: undefined as string | undefined,
                description: 'OpenAI model names (comma-separated).',
                showInDialog: true,
              },
            },
          },
          zhipu: {
            ...
            requiresRestart: true,
            default: {},
            description: 'Zhipu AI authentication settings.',
            showInDialog: false,
            properties: {
              apiKey: {
                type: 'string',
              ...
              model: {
                ...
                requiresRestart: true,
                default: undefined as string | undefined,
                description: 'Zhipu AI model (e.g., glm-4).',
                showInDialog: true,
              },
              baseUrl: {
                type: 'string',
              ...
              models: {
                ...
                requiresRestart: true,
                default: undefined as string | undefined,
                description: 'Zhipu AI model names (comma-separated).',
                showInDialog: true,
              },
            },
          },
