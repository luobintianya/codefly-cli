  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Codefly CLI model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
      ...
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running Codefly CLI in the home directory.',
        showInDialog: true,
      },
      ...
      auth: {
        ...
        properties: {
          openai: {
            ...
            requiresRestart: true,
            default: {},
            description: 'OpenAI Compatible authentication settings.',
            showInDialog: false,
            properties: {
              apiKey: {
                type: 'string',
