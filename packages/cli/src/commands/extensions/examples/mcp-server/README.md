...
Codefly CLI extension. It demonstrates how to expose tools and prompts to the
Codefly CLI.
...
- `codefly-extension.json`: The configuration file that tells Codefly CLI how to
  use this extension.
...
This example is typically used by `codefly extensions new`.
