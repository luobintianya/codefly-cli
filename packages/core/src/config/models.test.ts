...
describe('resolveModel', () => {
  describe('delegation logic', () => {
    ...
    it('should return the Default Pro model when auto-gemini-3 is requested as default', () => {
...
describe('isCodefly2Model', () => {
  it('should return true for gemini-2.5-pro', () => {
    expect(isCodefly2Model('gemini-2.5-pro')).toBe(true);
  });

  it('should return true for gemini-2.5-flash', () => {
    expect(isCodefly2Model('gemini-2.5-flash')).toBe(true);
  });

  it('should return true for gemini-2.0-flash', () => {
    expect(isCodefly2Model('gemini-2.0-flash')).toBe(true);
  });

  it('should return false for gemini-1.5-pro', () => {
    expect(isCodefly2Model('gemini-1.5-pro')).toBe(false);
  });

  it('should return false for gemini-3-pro', () => {
    expect(isCodefly2Model('gemini-3-pro')).toBe(false);
  });
