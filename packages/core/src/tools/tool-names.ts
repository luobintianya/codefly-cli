...
export const DATABASE_SCHEMA_TOOL_NAME = 'database_schema';
export const DRAWIO_TO_SQL_TOOL_NAME = 'drawio_to_sql';
export const SWAGGER_SCHEMA_TOOL_NAME = 'swagger_schema';
