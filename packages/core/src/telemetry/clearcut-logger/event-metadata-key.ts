...
export enum EventMetadataKey {
  ...
  CODEFLY_CLI_USER_PROMPT_LENGTH = 13,
  ...
  CODEFLY_CLI_TOOL_CALL_NAME = 14,

  // Logs the MCP server name.
  CODEFLY_CLI_TOOL_CALL_MCP_SERVER_NAME = 95,

  // Logs the user's decision about how to handle the tool call.
  CODEFLY_CLI_TOOL_CALL_DECISION = 15,

  // Logs whether the tool call succeeded.
  CODEFLY_CLI_TOOL_CALL_SUCCESS = 16,

  // Logs the tool call duration in milliseconds.
  CODEFLY_CLI_TOOL_CALL_DURATION_MS = 17,

  // Do not use.
  DEPRECATED_CODEFLY_CLI_TOOL_ERROR_MESSAGE = 18,

  // Logs the tool call error type, if any.
  CODEFLY_CLI_TOOL_CALL_ERROR_TYPE = 19,

  // Logs the length of tool output
  CODEFLY_CLI_TOOL_CALL_CONTENT_LENGTH = 93,
  ...
  CODEFLY_CLI_EDIT_STRATEGY = 109,

  // Logs a edit correction event.
  CODEFLY_CLI_EDIT_CORRECTION = 110,

  // Logs the reason for web fetch fallback.
  CODEFLY_CLI_WEB_FETCH_FALLBACK_REASON = 116,
  ...
  CODEFLY_CLI_API_REQUEST_MODEL = 20,
  ...
  CODEFLY_CLI_API_RESPONSE_MODEL = 21,

  // Logs the status code of the response.
  CODEFLY_CLI_API_RESPONSE_STATUS_CODE = 22,

  // Logs the duration of the API call in milliseconds.
  CODEFLY_CLI_API_RESPONSE_DURATION_MS = 23,

  // Logs the input token count of the API call.
  CODEFLY_CLI_API_RESPONSE_INPUT_TOKEN_COUNT = 25,

  // Logs the output token count of the API call.
  CODEFLY_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT = 26,

  // Logs the cached token count of the API call.
  CODEFLY_CLI_API_RESPONSE_CACHED_TOKEN_COUNT = 27,

  // Logs the thinking token count of the API call.
  CODEFLY_CLI_API_RESPONSE_THINKING_TOKEN_COUNT = 28,

  // Logs the tool use token count of the API call.
  CODEFLY_CLI_API_RESPONSE_TOOL_TOKEN_COUNT = 29,

  // Logs the token count for system instructions.
  CODEFLY_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_SYSTEM_INSTRUCTIONS = 167,

  // Logs the token count for tool definitions.
  CODEFLY_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_DEFINITIONS = 168,

  // Logs the token count for conversation history.
  CODEFLY_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_HISTORY = 169,

  // Logs the token count for tool calls (JSON map of tool name to tokens).
  CODEFLY_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_CALLS = 170,

  // Logs the token count from MCP servers (tool definitions + tool inputs/outputs).
  CODEFLY_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_MCP_SERVERS = 171,
  ...
  // Logs the model id of the API call.
  CODEFLY_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  CODEFLY_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  CODEFLY_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  CODEFLY_CLI_API_ERROR_DURATION_MS = 33,
  ...
  // Logs the Prompt Id
  CODEFLY_CLI_PROMPT_ID = 35,

  // Logs the Auth type for the prompt, api responses and errors.
  CODEFLY_CLI_AUTH_TYPE = 36,

  // Logs the total number of Google accounts ever used.
  CODEFLY_CLI_GOOGLE_ACCOUNTS_COUNT = 37,

  // Logs the Surface from where the Codefly CLI was invoked, eg: VSCode.
  CODEFLY_CLI_SURFACE = 39,

  // Logs the session id
  CODEFLY_CLI_SESSION_ID = 40,

  // Logs the Codefly CLI version
  CODEFLY_CLI_VERSION = 54,

  // Logs the Codefly CLI Git commit hash
  CODEFLY_CLI_GIT_COMMIT_HASH = 55,

  // Logs the Codefly CLI OS
  CODEFLY_CLI_OS = 82,

  // Logs active user settings
  CODEFLY_CLI_USER_SETTINGS = 84,

  // Logs the name of the GitHub Action workflow that triggered the session.
  CODEFLY_CLI_GH_WORKFLOW_NAME = 130,

  // Logs the active experiment IDs for the session.
  CODEFLY_CLI_EXPERIMENT_IDS = 131,

  // Logs the repository name of the GitHub Action that triggered the session.
  CODEFLY_CLI_GH_REPOSITORY_NAME_HASH = 132,
  ...
  CODEFLY_CLI_LOOP_DETECTED_TYPE = 38,
  ...
  CODEFLY_CLI_SLASH_COMMAND_NAME = 41,

  // Logs the subcommand of the slash command.
  CODEFLY_CLI_SLASH_COMMAND_SUBCOMMAND = 42,

  // Logs the status of the slash command (e.g. 'success', 'error')
  CODEFLY_CLI_SLASH_COMMAND_STATUS = 51,
  ...
  CODEFLY_CLI_RESPONSE_FINISH_REASON = 43,

  // Logs the result of the next speaker check
  CODEFLY_CLI_NEXT_SPEAKER_CHECK_RESULT = 44,
  ...
  CODEFLY_CLI_MALFORMED_JSON_RESPONSE_MODEL = 45,
  ...
  // Do not use.
  DEPRECATED_CODEFLY_CLI_KITTY_TRUNCATED_SEQUENCE = 52,

  // Logs the length of the kitty sequence that overflowed.
  CODEFLY_CLI_KITTY_SEQUENCE_LENGTH = 53,
  ...
  CODEFLY_CLI_RESEARCH_OPT_IN_STATUS = 66,

  // Logs the contact email for research participation
  CODEFLY_CLI_RESEARCH_CONTACT_EMAIL = 67,

  // Logs the user ID for research events
  CODEFLY_CLI_RESEARCH_USER_ID = 68,

  // Logs the type of research feedback
  CODEFLY_CLI_RESEARCH_FEEDBACK_TYPE = 69,

  // Logs the content of research feedback
  CODEFLY_CLI_RESEARCH_FEEDBACK_CONTENT = 70,

  // Logs survey responses for research feedback (JSON stringified)
  CODEFLY_CLI_RESEARCH_SURVEY_RESPONSES = 71,
  ...
  CODEFLY_CLI_INVALID_CHUNK_ERROR_MESSAGE = 75,

  // Logs the attempt number for a content retry.
  CODEFLY_CLI_CONTENT_RETRY_ATTEMPT_NUMBER = 76,

  // Logs the error type for a content retry.
  CODEFLY_CLI_CONTENT_RETRY_ERROR_TYPE = 77,

  // Logs the delay in milliseconds for a content retry.
  CODEFLY_CLI_CONTENT_RETRY_DELAY_MS = 78,

  // Logs the total number of attempts for a content retry failure.
  CODEFLY_CLI_CONTENT_RETRY_FAILURE_TOTAL_ATTEMPTS = 79,

  // Logs the final error type for a content retry failure.
  CODEFLY_CLI_CONTENT_RETRY_FAILURE_FINAL_ERROR_TYPE = 80,

  // Logs the total duration in milliseconds for a content retry failure.
  CODEFLY_CLI_CONTENT_RETRY_FAILURE_TOTAL_DURATION_MS = 81,

  // Logs the current nodejs version
  CODEFLY_CLI_NODE_VERSION = 83,
  ...
  CODEFLY_CLI_EXTENSION_NAME = 85,

  // Logs the name of the extension.
  CODEFLY_CLI_EXTENSION_ID = 121,

  // Logs the version of the extension.
  CODEFLY_CLI_EXTENSION_VERSION = 86,

  // Logs the previous version of the extension.
  CODEFLY_CLI_EXTENSION_PREVIOUS_VERSION = 117,

  // Logs the source of the extension.
  CODEFLY_CLI_EXTENSION_SOURCE = 87,

  // Logs the status of the extension install.
  CODEFLY_CLI_EXTENSION_INSTALL_STATUS = 88,

  // Logs the status of the extension uninstall
  CODEFLY_CLI_EXTENSION_UNINSTALL_STATUS = 96,

  // Logs the status of the extension uninstall
  CODEFLY_CLI_EXTENSION_UPDATE_STATUS = 118,

  // Logs the count of extensions in Start Session Event
  CODEFLY_CLI_START_SESSION_EXTENSIONS_COUNT = 119,

  // Logs the name of extensions as a comma-separated string
  CODEFLY_CLI_START_SESSION_EXTENSION_IDS = 120,

  // Logs the setting scope for an extension enablement.
  CODEFLY_CLI_EXTENSION_ENABLE_SETTING_SCOPE = 102,

  // Logs the setting scope for an extension disablement.
  CODEFLY_CLI_EXTENSION_DISABLE_SETTING_SCOPE = 107,
  ...
  CODEFLY_CLI_TOOL_OUTPUT_TRUNCATED_ORIGINAL_LENGTH = 89,

  // Logs the truncated length of the tool output.
  CODEFLY_CLI_TOOL_OUTPUT_TRUNCATED_TRUNCATED_LENGTH = 90,

  // Logs the threshold at which the tool output was truncated.
  CODEFLY_CLI_TOOL_OUTPUT_TRUNCATED_THRESHOLD = 91,

  // Logs the number of lines the tool output was truncated to.
  CODEFLY_CLI_TOOL_OUTPUT_TRUNCATED_LINES = 92,
  ...
  CODEFLY_CLI_LLM_LOOP_CHECK_FLASH_CONFIDENCE = 126,

  // Logs the name of the main model used for the secondary loop check.
  CODEFLY_CLI_LLM_LOOP_CHECK_MAIN_MODEL = 127,

  // Logs the confidence score from the main model loop check.
  CODEFLY_CLI_LLM_LOOP_CHECK_MAIN_MODEL_CONFIDENCE = 128,

  // Logs the model that confirmed the loop.
  CODEFLY_CLI_LOOP_DETECTED_CONFIRMED_BY_MODEL = 129,
  ...
  CODEFLY_CLI_ACTIVE_APPROVAL_MODE = 141,

  // Logs the new approval mode.
  CODEFLY_CLI_APPROVAL_MODE_TO = 142,

  // Logs the duration spent in an approval mode in milliseconds.
  CODEFLY_CLI_APPROVAL_MODE_DURATION_MS = 143,
  ...
  CODEFLY_CLI_REWIND_OUTCOME = 144,

  // Model Routing Event Keys (Cont.)
  // ==========================================================================

  // Logs the reasoning for the routing decision.
  CODEFLY_CLI_ROUTING_REASONING = 145,

  // Logs whether numerical routing was enabled.
  CODEFLY_CLI_ROUTING_NUMERICAL_ENABLED = 146,

  // Logs the classifier threshold used.
  CODEFLY_CLI_ROUTING_CLASSIFIER_THRESHOLD = 147,
