...
export const EVENT_CLI_CONFIG = 'codefly_cli.config';
export class StartSessionEvent implements BaseTelemetryEvent {
  ...
  constructor(config: Config, toolRegistry?: ToolRegistry) {
    ...
    let useCodefly = false;
    let useVertex = false;
    if (generatorConfig && generatorConfig.authType) {
      useCodefly = generatorConfig.authType === AuthType.USE_CODEFLY;
    ...
    this.api_key_enabled = useCodefly || useVertex;
...
export const EVENT_USER_PROMPT = 'codefly_cli.user_prompt';
...
export const EVENT_TOOL_CALL = 'codefly_cli.tool_call';
...
export const EVENT_API_REQUEST = 'codefly_cli.api_request';
...
export const EVENT_API_ERROR = 'codefly_cli.api_error';
...
export const EVENT_API_RESPONSE = 'codefly_cli.api_response';
...
export const EVENT_FLASH_FALLBACK = 'codefly_cli.flash_fallback';
...
export const EVENT_RIPGREP_FALLBACK = 'codefly_cli.ripgrep_fallback';
...
export const EVENT_NEXT_SPEAKER_CHECK = 'codefly_cli.next_speaker_check';
...
export const EVENT_CONSECA_POLICY_GENERATION =
  'codefly_cli.conseca.policy_generation';
...
export const EVENT_CONSECA_VERDICT = 'codefly_cli.conseca.verdict';
...
export const EVENT_SLASH_COMMAND = 'codefly_cli.slash_command';
...
export const EVENT_REWIND = 'codefly_cli.rewind';
...
export const EVENT_CHAT_COMPRESSION = 'codefly_cli.chat_compression';
...
export const EVENT_MALFORMED_JSON_RESPONSE =
  'codefly_cli.malformed_json_response';
...
export const EVENT_IDE_CONNECTION = 'codefly_cli.ide_connection';
...
export const EVENT_CONVERSATION_FINISHED = 'codefly_cli.conversation_finished';
...
export const EVENT_FILE_OPERATION = 'codefly_cli.file_operation';
...
export const EVENT_INVALID_CHUNK = 'codefly_cli.chat.invalid_chunk';
...
export const EVENT_CONTENT_RETRY = 'codefly_cli.chat.content_retry';
...
export const EVENT_CONTENT_RETRY_FAILURE =
  'codefly_cli.chat.content_retry_failure';
...
export const EVENT_MODEL_ROUTING = 'codefly_cli.model_routing';
...
export const EVENT_EXTENSION_INSTALL = 'codefly_cli.extension_install';
...
export const EVENT_TOOL_OUTPUT_TRUNCATED = 'codefly_cli.tool_output_truncated';
...
export const EVENT_TOOL_OUTPUT_MASKING = 'codefly_cli.tool_output_masking';
...
export const EVENT_EXTENSION_UNINSTALL = 'codefly_cli.extension_uninstall';
...
export const EVENT_EXTENSION_UPDATE = 'codefly_cli.extension_update';
...
export const EVENT_EXTENSION_ENABLE = 'codefly_cli.extension_enable';
...
export const EVENT_MODEL_SLASH_COMMAND = 'codefly_cli.slash_command.model';
...
export const EVENT_LLM_LOOP_CHECK = 'codefly_cli.llm_loop_check';
...
export const EVENT_EXTENSION_DISABLE = 'codefly_cli.extension_disable';
...
export const EVENT_EDIT_STRATEGY = 'codefly_cli.edit_strategy';
...
export const EVENT_EDIT_CORRECTION = 'codefly_cli.edit_correction';
...
export const EVENT_STARTUP_STATS = 'codefly_cli.startup_stats';
...
export const EVENT_AGENT_START = 'codefly_cli.agent.start';
...
export const EVENT_AGENT_FINISH = 'codefly_cli.agent.finish';
...
export const EVENT_WEB_FETCH_FALLBACK_ATTEMPT =
  'codefly_cli.web_fetch_fallback_attempt';
...
export const EVENT_HOOK_CALL = 'codefly_cli.hook_call';

export const EVENT_APPROVAL_MODE_SWITCH =
  'codefly_cli.plan.approval_mode_switch';
...
export const EVENT_APPROVAL_MODE_DURATION =
  'codefly_cli.plan.approval_mode_duration';
...
export const EVENT_PLAN_EXECUTION = 'codefly_cli.plan.execution';
...
export const EVENT_KEYCHAIN_AVAILABILITY = 'codefly_cli.keychain.availability';
...
export const EVENT_TOKEN_STORAGE_INITIALIZATION =
  'codefly_cli.token_storage.initialization';
