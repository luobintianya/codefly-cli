...
Promise.allSettled([
  ...
  if (cliResult.status === 'rejected') {
    console.error('codefly.js build failed:', cliResult.reason);
    process.exit(1);
  }
  // error in a2a-server bundling will not stop codefly.js bundling process
