...
The
[Official Codefly CLI Roadmap](https://github.com/orgs/google-codefly/projects/11/)

Codefly CLI is an open-source AI agent that brings the power of Codefly directly
into your terminal. It provides lightweight access to Codefly, giving you the
most direct path from your prompt to our model.

This document outlines our approach to the Codefly CLI roadmap. Here, you'll
find our guiding principles and a breakdown of the key areas we are focused on
for development. Our roadmap is not a static list but a dynamic set of
priorities that are tracked live in our GitHub Issues.

As an
[Apache 2.0 open source project](https://github.com/google-codefly/codefly-cli?tab=Apache-2.0-1-ov-file#readme),
we appreciate and welcome
[public contributions](https://github.com/google-codefly/codefly-cli/blob/main/CONTRIBUTING.md),
...
[opening an issue for discussion](https://github.com/google-codefly/codefly-cli/issues/new/choose).
...
- **Power & Simplicity:** Deliver access to state-of-the-art Codefly models with
...
- **Intelligent:** Codefly CLI should be reliably ranked among the best agentic
...
Roadmap Issue [here](https://github.com/google-codefly/codefly-cli/issues/4191).
...
- **User Experience:** Improve the CLI's usability, performance, interactive
  ...
  - **Internationalization:** Support multiple languages in the CLI UI and
    ensure AI responses align with the `general.language` setting.
- **Tooling:** Built-in tools and the MCP ecosystem.
- **Core:** Core functionality of the CLI
- **Extensibility:** Bringing Codefly CLI to other surfaces e.g. GitHub.
...
Codefly CLI is an open-source project, and we welcome contributions from the
community! Whether you're a developer, a designer, or just an enthusiastic user
you can find our
[Community Guidelines here](https://github.com/google-codefly/codefly-cli/blob/main/CONTRIBUTING.md)
to learn how to get started. There are many ways to get involved:

- **Roadmap:** Please review and find areas in our
  [roadmap](https://github.com/google-codefly/codefly-cli/issues/4191) that you
...
- **Report Bugs:** If you find an issue, please create a
  [bug](https://github.com/google-codefly/codefly-cli/issues/new?template=bug_report.yml)
...
- **Suggest Features:** Have a great idea? We'd love to hear it! Open a
  [feature request](https://github.com/google-codefly/codefly-cli/issues/new?template=feature_request.yml).
- **Contribute Code:** Check out our
  [CONTRIBUTING.md](https://github.com/google-codefly/codefly-cli/blob/main/CONTRIBUTING.md)
...
- **Write Documentation:** Help us improve our documentation, tutorials, and
  examples. We are excited about the future of Codefly CLI and look forward to
