# Build Codefly CLI extensions

Codefly CLI extensions let you expand the capabilities of Codefly CLI by adding
...
Before you start, ensure you have the Codefly CLI installed and a basic
understanding of Node.js.

## Extension features

Extensions offer several ways to customize Codefly CLI. Use this table to decide
...
The manifest file tells Codefly CLI how to load and use your extension.
...
When a user installs this extension, Codefly CLI will prompt them to enter the
...
Link your extension to your Codefly CLI installation for local development.
...
Restart your Codefly CLI session to use the new `fetch_posts` tool. Test it by
asking: "fetch posts".
...
After saving the file, restart Codefly CLI. Run `/fs:grep-code "some pattern"` to
use your new command.

## Step 6: Add a custom `CODEFLY.md`

Provide persistent context to the model by adding a `CODEFLY.md` file to your
extension. This is useful for setting behavior or providing essential tool
information.

1.  Create a file named `CODEFLY.md` in the root of your extension directory:
...
2.  Update your `codefly-extension.json` to load this file:
...
Restart Codefly CLI. The model now has the context from your `CODEFLY.md` file in
...
Codefly CLI automatically discovers skills bundled with your extension. The model
