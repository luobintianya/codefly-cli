...
The `activate_skill` tool lets Codefly CLI load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. Codefly CLI uses this
...
The `activate_skill` tool is used exclusively by the Codefly agent. You cannot
