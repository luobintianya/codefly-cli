# Codefly CLI examples

Codefly CLI helps you automate common engineering tasks by combining AI
reasoning with local system tools. This document provides examples of how to use
the CLI for file management, code analysis, and data transformation.
...
You can use Codefly CLI to automate file management tasks that require visual
analysis. In this example, Codefly CLI renames images based on their actual
subject matter.
...
Give Codefly the following prompt:

```cli
Rename the photos in my "photos" directory based on their contents.
```

Result: Codefly asks for permission to rename your files.
...
Codefly CLI is effective for rapid codebase exploration. The following example
shows how to ask Codefly CLI to fetch, analyze, and summarize a remote project.

Scenario: You want to understand how a popular open-source utility works by
inspecting its code, not just its README.

Give Codefly CLI the following prompt:

```cli
Clone the 'chalk' repository from https://github.com/chalk/chalk, read its key source files, and explain how it works.
```

Result: Codefly performs a sequence of actions to answer your request.
...
Codefly CLI returns an explanation based on the actual source code:
...
Codefly CLI can process and transform data across multiple files. Use this
...
Result: Codefly CLI reads each file and then asks for permission to write a new
file. Provide your permission and Codefly CLI provides the combined data:
...
Codefly CLI can generate boilerplate code and tests based on your existing
...
Result: Codefly CLI asks for permission to write a new file and creates a test
for your login page.
