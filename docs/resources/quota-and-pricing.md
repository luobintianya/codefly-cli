# Codefly CLI: Quotas and pricing

Codefly CLI offers a generous free tier that covers many individual developers'
...
This article outlines the specific quotas and pricing applicable to Codefly CLI
...
### Log in with Google (Codefly Code Assist for individuals)

For users who authenticate by using their Google account to access Codefly Code
Assist for individuals. This includes:

- 1000 model requests / user / day
- 60 model requests / user / minute
- Model requests will be made across the Codefly model family as determined by
  Codefly CLI.

Learn more at
[Codefly Code Assist for Individuals Limits](https://developers.google.com/codefly-code-assist/resources/quotas#quotas-for-agent-mode-codefly-cli).

### Log in with Codefly API Key (unpaid)

If you are using a Codefly API key, you can also benefit from a free tier. This
includes:
...
Learn more at
[Codefly API Rate Limits](https://ai.google.dev/codefly-api/docs/rate-limits).
...
Codefly CLI by upgrading to one of the following subscriptions:

- [Google AI Pro and AI Ultra](https://codefly.google/subscriptions/). This is
  ...
  Learn more at
  [Codefly Code Assist Quotas and Limits](https://developers.google.com/codefly-code-assist/resources/quotas)

- [Purchase a Codefly Code Assist Subscription through Google Cloud ](https://cloud.google.com/codefly/docs/codeassist/overview)
  by signing up in the Google Cloud console. Learn more at
  [Set up Codefly Code Assist](https://cloud.google.com/codefly/docs/discover/set-up-codefly).
  ...
  This includes:
  - Codefly Code Assist Standard edition:
    - 1500 model requests / user / day
    - 120 model requests / user / minute
  - Codefly Code Assist Enterprise edition:
    - 2000 model requests / user / day
    - 120 model requests / user / minute
  - Model requests will be made across the Codefly model family as determined by
    Codefly CLI.

  [Learn more about Codefly Code Assist Standard and Enterprise license limits](https://developers.google.com/codefly-code-assist/resources/quotas#quotas-for-agent-mode-codefly-cli).
...
Learn more at
[Codefly API Rate Limits](https://ai.google.dev/codefly-api/docs/rate-limits),
[Codefly API Pricing](https://ai.google.dev/codefly-api/docs/pricing)
...
## Codefly for workspace plans

These plans currently apply only to the use of Codefly web-based products
provided by Google-based experiences (for example, the Codefly web app or the
Flow video editor). These plans do not apply to the API usage which powers the
Codefly CLI. Supporting these plans is under active consideration for future
support.
