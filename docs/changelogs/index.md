...
- **Extension Exploration:** New UI and settings to explore and manage
  ...
  ([#18686](https://github.com/google-codefly/codefly-cli/pull/18686) by
  @sripasg).
- **Admin Control:** Administrators can now allowlist specific MCP server
  configurations
  ([#18311](https://github.com/google-codefly/codefly-cli/pull/18311) by
  @skeshive).
...
- **Slash Command:** We've added a new `/prompt-suggest` slash command to help
  ...
  ([#17264](https://github.com/google-codefly/codefly-cli/pull/17264) by
  @NTaylorMullen).
- **IDE Support:** Codefly CLI now supports the Positron IDE
  ([#15047](https://github.com/google-codefly/codefly-cli/pull/15047) by
  @kapsner).
...
- **Event-Driven Architecture:** The CLI now uses a new event-driven scheduler
  ...
  ([#17078](https://github.com/google-codefly/codefly-cli/pull/17078) by
  @abhipatel12).
...
- **New `/rewind` Command:** Easily navigate your session history with the new
  `/rewind` command
  ([#15720](https://github.com/google-codefly/codefly-cli/pull/15720) by
  @Adib234).
- **Linux Clipboard Support:** You can now paste images on Linux with Wayland
  and X11 ([#17144](https://github.com/google-codefly/codefly-cli/pull/17144) by
  @devr0306).

## Announcements: v0.26.0 - 2026-01-27

- **Agents and Skills:** We've introduced a new `skill-creator` skill
  ([#16394](https://github.com/google-codefly/codefly-cli/pull/16394) by
...
- **Core Functionality & Performance:** This release includes support for
  ...
  ([#16489](https://github.com/google-codefly/codefly-cli/pull/16489) by
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  and powerful automation within Codefly CLI.
  ([#15869](https://github.com/google-codefly/codefly-cli/pull/15869) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16013](https://github.com/google-codefly/codefly-cli/pull/16013) by
...
- **Improved UI/UX:** The user interface has received several updates, featuring
  ...
  and input areas.
  ([#15408](https://github.com/google-codefly/codefly-cli/pull/15408) by
...
- **Enhanced Security:** Security has been a major focus, with default folder
  ...
  ([#15943](https://github.com/google-codefly/codefly-cli/pull/15943) by
  [@galz10](https://github.com/galz10)),
  ([#15977](https://github.com/google-codefly/codefly-cli/pull/15977) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Core Functionality:** This release includes a mandatory MessageBus
  ...
  ([#15776](https://github.com/google-codefly/codefly-cli/pull/15776) by
  [@abhipatel12](https://github.com/abhipatel12)),
  ([#16300](https://github.com/google-codefly/codefly-cli/pull/16300) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Terminal Features:** Terminal interactions are more seamless with new
  ...
  ([#15336](https://github.com/google-codefly/codefly-cli/pull/15336) by
  [@scidomino](https://github.com/scidomino)),
  ([#15932](https://github.com/google-codefly/codefly-cli/pull/15932) by
  [@scidomino](https://github.com/scidomino))
- **New Commands:** To manage the new features, we've added several new
  ...
  ([#16204](https://github.com/google-codefly/codefly-cli/pull/16204) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#15865](https://github.com/google-codefly/codefly-cli/pull/15865) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16377](https://github.com/google-codefly/codefly-cli/pull/16377) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))

## Announcements: v0.23.0 - 2026-01-07

- 🎉 **Experimental Agent Skills Support in Preview:** Codefly CLI now supports
  [Agent Skills](https://agentskills.io/home) in our preview builds. This is an
  early preview where we’re looking for feedback!
  - Install Preview: `npm install -g @codeflyai/codefly@preview`
  - Enable in `/settings`
  - Docs:
    [https://codeflycli.com/docs/cli/skills/](https://codeflycli.com/docs/cli/skills/)
- **Codefly CLI wrapped:** Run `npx codefly-wrapped` to visualize your usage
...
- **Windows clipboard image support:** Windows users can now paste images
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/13997) by
...
- **Terminal background color detection:** Automatically optimizes your
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/15132) by
...
- **Session logout:** Use the new `/logout` command to instantly clear
  ...
  switching. ([pr](https://github.com/google-codefly/codefly-cli/pull/13383) by
  [@CN-Scars](https://github.com/CN-Scars))

## Announcements: v0.22.0 - 2025-12-22

- 🎉**Free Tier + Codefly 3:** Free tier users now all have access to Codefly 3
  Pro & Flash. Enable in `/settings` by toggling "Preview Features" to `true`.
- 🎉**Codefly CLI + Colab:** Codefly CLI is now pre-installed. Can be used
  headlessly in notebook cells or interactively in the built-in terminal
  ([pic](https://imgur.com/a/G0Tn7vi))
- 🎉**Codefly CLI Extensions:**
  - **Conductor:** Planning++, Codefly works with you to build out a detailed
    plan, pull in extra details as needed, ultimately to give the LLM guardrails
    with artifacts. Measure twice, implement once!

    `codefly extensions install https://github.com/codefly-cli-extensions/conductor`

    Blog:
    [https://developers.googleblog.com/conductor-introducing-context-driven-development-for-codefly-cli/](https://developers.googleblog.com/conductor-introducing-context-driven-development-for-codefly-cli/)

  - **Endor Labs:** Perform code analysis, vulnerability scanning, and
    dependency checks using natural language.

    `codefly extensions install https://github.com/endorlabs/codefly-extension`
...
- 🎉 Codefly CLI Extensions:
  - Rill: Utilize natural language to analyze Rill data, enabling the
    ...
    `codefly extensions install https://github.com/rilldata/rill-codefly-extension`
  - Browserbase: Interact with web pages, take screenshots, extract information,
    ...
    `codefly extensions install https://github.com/browserbase/mcp-server-browserbase`
...
- **Multi-file Drag & Drop:** Users can now drag and drop multiple files into
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/14832) by
...
- **Persistent "Always Allow" Policies:** Users can now save "Always Allow"
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/14737) by
...
- 🎉 **New extensions:**
  - **Eleven Labs:** Create, play, manage your audio play tracks with the Eleven
    Labs Codefly CLI extension:
    `codefly extensions install https://github.com/elevenlabs/elevenlabs-mcp`
- **Zed integration:** Users can now leverage Codefly 3 within the Zed
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/13398) by
...
- **Interactive shell:**
  - **Click-to-Focus:** When "Use Alternate Buffer" setting is enabled, users
    ...
    ([pr](https://github.com/google-codefly/codefly-cli/pull/13341) by
    [@galz10](https://github.com/galz10))
...
- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Codefly CLI with your Workspace data. Write
    docs, build slides, chat with others or even get your calc on in sheets:
    `codefly extensions install https://github.com/codefly-cli-extensions/workspace`
    - Blog:
  ...
  - **Redis:** Manage and search data in Redis with natural language:
    `codefly extensions install https://github.com/redis/mcp-redis`
  - **Anomalo:** Query your data warehouse table metadata and quality status
    through commands and natural language:
    `codefly extensions install https://github.com/datagravity-ai/anomalo-codefly-extension`
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Codefly CLI. This allows users and administrators to create
...
- **Model in history:** Users can now toggle in `/settings` to display model in
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/13034) by
  [@scidomino](https://github.com/scidomino))
- **Multi-uninstall:** Users can now uninstall multiple extensions with a single
  command. ([pic](https://imgur.com/a/9Dtq8u2),
  [pr](https://github.com/google-codefly/codefly-cli/pull/13016) by
  [@JayadityaGit](https://github.com/JayadityaGit))

## Announcements: v0.16.0 - 2025-11-10

- **Codefly 3 + Codefly CLI:** launch 🚀🚀🚀
- **Data Commons Codefly CLI Extension** - A new Data Commons Codefly CLI
  ...
  be found at
  [https://github.com/codefly-cli-extensions/datacommons](https://github.com/codefly-cli-extensions/datacommons).

## Announcements: v0.15.0 - 2025-11-03

- **🎉 Seamless scrollable UI and mouse support:** We’ve given Codefly CLI a
...
- **🎉 New partner extensions:**
  - **Arize:** Seamlessly instrument AI applications with Arize AX and grant
    ...
    `codefly extensions install https://github.com/Arize-ai/arize-tracing-assistant`

  - **Chronosphere:** Retrieve logs, metrics, traces, events, and specific
    entities:

    `codefly extensions install https://github.com/chronosphereio/chronosphere-mcp`
  ...
  - **Transmit:** Comprehensive context, validation, and automated fixes for
    ...
    `codefly extensions install https://github.com/TransmitSecurity/transmit-security-journey-builder`
...
- **Todo planning:** Complex questions now get broken down into todo lists that
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/12905) by
...
- **Disable GitHub extensions:** Users can now prevent the installation and
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/12838) by
...
- **Extensions restart:** Users can now explicitly restart extensions using the
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/12739) by
  [@jakemac53](https://github.com/jakemac53)).
- **Better Angular support:** Angular workflows should now be more seamless
  ([pr](https://github.com/google-codefly/codefly-cli/pull/10252) by
  [@MarkTechson](https://github.com/MarkTechson)).
- **Validate command:** Users can now check that local extensions are formatted
  correctly. ([pr](https://github.com/google-codefly/codefly-cli/pull/12186) by
  [@kevinjwang1](https://github.com/kevinjwang1)).

## Announcements: v0.12.0 - 2025-10-27

![Codebase investigator subagent in Codefly CLI.](https://i.imgur.com/4J1njsx.png)
...
- **🎉 New partner extensions:**
  - **🤗 Hugging Face extension:** Access the Hugging Face hub.
    ...
    `codefly extensions install https://github.com/huggingface/hf-mcp-server`
  ...
  - **Monday.com extension**: Analyze your sprints, update your task boards,
    ...
    `codefly extensions install https://github.com/mondaycom/mcp`
  ...
  - **Data Commons extension:** Query public datasets or ground responses on
    ...
    `codefly extensions install https://github.com/codefly-cli-extensions/datacommons`

- **Model selection:** Choose the Codefly model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/google-codefly/codefly-cli/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Codefly CLI will now intelligently pick the best model for
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/9262) by
  [@abhipatel12](https://github.com/abhipatel12)).
  - Discussion:
    [https://github.com/google-codefly/codefly-cli/discussions/12375](https://github.com/google-codefly/codefly-cli/discussions/12375)
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/9988) by
  [@abhipatel12](https://github.com/abhipatel12),
  [pr](https://github.com/google-codefly/codefly-cli/pull/10282) by
  ...
  - Enable, disable, or limit turns in `/settings`, plus advanced configs in
    ...
    [pr](https://github.com/google-codefly/codefly-cli/pull/10844) by
    [@silviojr](https://github.com/silviojr)).
...
- **API key authentication:** Users can now securely enter and store their
  Codefly API key via a new dialog, eliminating the need for environment
  variables and repeated entry.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/11760) by
  [@galz10](https://github.com/galz10)).
- **Sequential approval:** Users can now approve multiple tool calls
  sequentially during execution.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/11593) by
  [@joshualitt](https://github.com/joshualitt)).
...
- 🎉 **Codefly CLI Jules Extension:** Use Codefly CLI to orchestrate Jules. Spawn
  ...
  - Announcement:
    [https://developers.googleblog.com/en/introducing-the-jules-extension-for-codefly-cli/](https://developers.googleblog.com/en/introducing-the-jules-extension-for-codefly-cli/)
- **Stream JSON output:** Stream real-time JSONL events with
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/10883) by
  [@anj-s](https://github.com/anj-s))
- **Markdown toggle:** Users can now switch between rendered and raw markdown
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/10383) by
...
- **Queued message editing:** Users can now quickly edit queued messages by
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/10392) by
...
- **JSON web fetch**: Non-HTML content like JSON APIs or raw source code are now
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/11284) by
  [@abhipatel12](https://github.com/abhipatel12))
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `codefly "/some-mcp-prompt"`.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/10194) by
  [@capachino](https://github.com/capachino))
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Codefly CLI’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Codefly CLI.
    ([pr](https://github.com/google-codefly/codefly-cli/pull/11228) by
    [@allenhutchison](https://github.com/allenhutchison))
  - `--telemetry-*` flags in favor of
    [environment variables](https://github.com/google-codefly/codefly-cli/pull/11318)
    ([pr](https://github.com/google-codefly/codefly-cli/pull/11318) by
    [@allenhutchison](https://github.com/allenhutchison))
...
- **Interactive Shell Tool calling:** Codefly CLI can now also execute
  interactive tools if needed
  ([pr](https://github.com/google-codefly/codefly-cli/pull/11225) by
  [@galz10](https://github.com/galz10)).
- **Alt+Key support:** Enables broader support for Alt+Key keyboard shortcuts
  across different terminals.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/10767) by
  [@srivatsj](https://github.com/srivatsj)).
- **Telemetry Diff stats:** Track line changes made by the model and user during
  file operations via OTEL.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/10819) by
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `codefly` 😎 directly in Codefly CLI:
  - Blog:
    [https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-codefly-cli/](https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-codefly-cli/)
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest".
  ([pr](https://github.com/google-codefly/codefly-cli/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/10629) by
...
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/10108) by
  [@sgnagnarella](https://github.com/sgnagnarella))

## Announcements: v0.8.0 - 2025-09-29

- 🎉 **Announcing Codefly CLI Extensions** 🎉
  - Completely customize your Codefly CLI experience to fit your workflow.
  - Build and share your own Codefly CLI extensions with the world.
  - Launching with a growing catalog of community, partner, and Google-built
    extensions.
    - Check extensions from
      [key launch partners](https://github.com/google-codefly/codefly-cli/discussions/10718).
  - Easy install:
    - `codefly extensions install <github url|folder path>`
  - Easy management:
    - `codefly extensions install|uninstall|link`
    - `codefly extensions enable|disable`
    - `codefly extensions list|update|new`
  - Or use commands while running with `/extensions list|update`.
  - Everything you need to know:
    [Now open for building: Introducing Codefly CLI extensions](https://blog.google/technology/developers/codefly-cli-extensions/).
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - _Homepage:_ [https://codeflycli.com](https://codeflycli.com)
  - ‼️*NEW documentation:*
    [https://codeflycli.com/docs](https://codeflycli.com/docs) (Have any
    [suggestions](https://github.com/google-codefly/codefly-cli/discussions/8722)?)
  - _Extensions:_
    [https://codeflycli.com/extensions](https://codeflycli.com/extensions)
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  non-interactive mode.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/9114) by
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/4386) by
...
- 🎉**Build your own Codefly CLI IDE plugin:** We've published a spec for
  creating IDE plugins to enable rich context-aware experiences and native
  in-editor diffing in your IDE of choice.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8479) by
  [@skeshive](https://github.com/skeshive))
- 🎉 **Codefly CLI extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Codefly CLI
    ([extension](https://github.com/codefly-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Codefly CLI
    ([extension](https://github.com/codefly-cli-extensions/nanobanana))
- **Telemetry config via environment:** Manage telemetry settings using
  environment variables for a more flexible setup.
  ([docs](https://github.com/google-codefly/codefly-cli/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/google-codefly/codefly-cli/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true`
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8761) by
  [@anj-s](https://github.com/anj-s))
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8570) by
  [@scidomino](https://github.com/scidomino))
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  the command line in non-interactive mode: `codefly "/joke Chuck Norris"`
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉**Codefly CLI Databases and BigQuery Extensions:** Connect Codefly CLI to all
  ...
  - **AlloyDB:** Interact, manage and observe AlloyDB for PostgreSQL databases
    ([manage](https://github.com/codefly-cli-extensions/alloydb#configuration),
    [observe](https://github.com/codefly-cli-extensions/alloydb-observability#configuration))
  - **BigQuery:** Connect and query your BigQuery datasets or utilize a
    sub-agent for contextual insights
    ([query](https://github.com/codefly-cli-extensions/bigquery-data-analytics#configuration),
    [sub-agent](https://github.com/codefly-cli-extensions/bigquery-conversational-analytics))
  - **Cloud SQL:** Interact, manage and observe Cloud SQL for PostgreSQL
    ([manage](https://github.com/codefly-cli-extensions/cloud-sql-postgresql#configuration),[ observe](https://github.com/codefly-cli-extensions/cloud-sql-postgresql-observability#configuration)),
    Cloud SQL for MySQL
    ([manage](https://github.com/codefly-cli-extensions/cloud-sql-mysql#configuration),[ observe](https://github.com/codefly-cli-extensions/cloud-sql-mysql-observability#configuration))
    and Cloud SQL for SQL Server
    ([manage](https://github.com/codefly-cli-extensions/cloud-sql-sqlserver#configuration),[ observe](https://github.com/codefly-cli-extensions/cloud-sql-sqlserver-observability#configuration))
    databases.
  - **Dataplex:** Discover, manage, and govern data and AI artifacts
    ([extension](https://github.com/codefly-cli-extensions/dataplex#configuration))
  - **Firestore:** Interact with Firestore databases, collections and documents
    ([extension](https://github.com/codefly-cli-extensions/firestore-native#configuration))
  - **Looker:** Query data, run Looks and create dashboards
    ([extension](https://github.com/codefly-cli-extensions/looker#configuration))
  - **MySQL:** Interact with MySQL databases
    ([extension](https://github.com/codefly-cli-extensions/mysql#configuration))
  - **Postgres:** Interact with PostgreSQL databases
    ([extension](https://github.com/codefly-cli-extensions/postgres#configuration))
  - **Spanner:** Interact with Spanner databases
    ([extension](https://github.com/codefly-cli-extensions/spanner#configuration))
  - **SQL Server:** Interact with SQL Server databases
    ([extension](https://github.com/codefly-cli-extensions/sql-server#configuration))
  - **MCP Toolbox:** Configure and load custom tools for more than 30+ data
    sources
    ([extension](https://github.com/codefly-cli-extensions/mcp-toolbox#configuration))
- **JSON output mode:** Have Codefly CLI output JSON with `--output-format json`
  when invoked headlessly for easy parsing and post-processing. Includes
  response, stats and errors.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8119) by
  [@jerop](https://github.com/jerop))
...
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/8200) by
...
- 🎉**FastMCP + Codefly CLI**🎉: Quickly install and manage your Codefly CLI MCP
  servers with FastMCP ([video](https://imgur.com/a/m8QdCPh),
  [pr](https://github.com/jlowin/fastmcp/pull/1709) by
  [@jackwotherspoon](https://github.com/jackwotherspoon)**)**
  - Getting started:
    [https://gofastmcp.com/integrations/codefly-cli](https://gofastmcp.com/integrations/codefly-cli)
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Codefly CLI
  headlessly via `codefly "Hello"`. Synonymous with passing `-p`.
  ([gif](https://imgur.com/a/hcBznpB),
  [pr](https://github.com/google-codefly/codefly-cli/pull/7668) by
  [@allenhutchison](https://github.com/allenhutchison))
...
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/google-codefly/codefly-cli/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  `"enforcedAuthType": "oauth-personal|codefly-api-key|…"`in `settings.json`.
  ([pr](https://github.com/google-codefly/codefly-cli/pull/6564) by
  [@chrstnb](https://github.com/chrstnb))
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases.
  ([feedback](https://github.com/google-codefly/codefly-cli/discussions/7822),
  [pr](https://github.com/google-codefly/codefly-cli/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
  **[https://codelabs.developers.google.com/codefly-cli-hands-on](https://codelabs.developers.google.com/codefly-cli-hands-on)
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    ...
    ([feedback](https://github.com/google-codefly/codefly-cli/discussions/7758),
    [pr](https://github.com/google-codefly/codefly-cli/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Codefly CLI to continue conversations on your behalf. This may be
    disruptive and can be disabled via `"skipNextSpeakerCheck": false` in your
    `settings.json`
    ([feedback](https://github.com/google-codefly/codefly-cli/discussions/6666),
    [pr](https://github.com/google-codefly/codefly-cli/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/google-codefly/codefly-cli/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json`
  ([pr](https://github.com/google-codefly/codefly-cli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true`
  ([pr](https://github.com/google-codefly/codefly-cli/pull/7350) by
  [@scidomino](https://github.com/scidomino))
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Custom commands @:** Embed local file or directory content directly into
  ...
  [pr](https://github.com/google-codefly/codefly-cli/pull/6716) by
  [@abhipatel12](https://github.com/abhipatel12))
- **2.5 Flash Lite support:** You can now use the `codefly-2.5-flash-lite` model
  for Codefly CLI via `codefly -m …`.
  ([gif](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*P4SKwnrsyBuULoHrFqsFKQ.gif),
  [pr](https://github.com/google-codefly/codefly-cli/pull/4652) by
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/google-codefly/codefly-cli/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/google-codefly/codefly-cli/pull/6923) by
