...
- fix(patch): cherry-pick 2c1d6f8 to release/v0.30.0-preview.4-pr-19369 to patch
  ...
  [#20086](https://github.com/google-codefly/codefly-cli/pull/20086)
- fix(patch): cherry-pick 261788c to release/v0.30.0-preview.0-pr-19453 to patch
  ...
  @codefly-cli-robot in
  [#19490](https://github.com/google-codefly/codefly-cli/pull/19490)
...
- feat(plan): document and validate Plan Mode policy overrides by @jerop in
  [#18825](https://github.com/google-codefly/codefly-cli/pull/18825)
- Fix pressing any key to exit select mode. by @jacob314 in
  [#18421](https://github.com/google-codefly/codefly-cli/pull/18421)
- fix(cli): update F12 behavior to only open drawer if browser fails by
  @SandyTao520 in
  [#18829](https://github.com/google-codefly/codefly-cli/pull/18829)
- feat(plan): allow skills to be enabled in plan mode by @Adib234 in
  [#18817](https://github.com/google-codefly/codefly-cli/pull/18817)
- docs(plan): add documentation for plan mode tools by @jerop in
  [#18827](https://github.com/google-codefly/codefly-cli/pull/18827)
- Remove experimental note in extension settings docs by @chrstnb in
  [#18822](https://github.com/google-codefly/codefly-cli/pull/18822)
- Update prompt and grep tool definition to limit context size by @gundermanc in
  [#18780](https://github.com/google-codefly/codefly-cli/pull/18780)
- docs(plan): add `ask_user` tool documentation by @jerop in
  [#18830](https://github.com/google-codefly/codefly-cli/pull/18830)
- Revert unintended credentials exposure by @Adib234 in
  [#18840](https://github.com/google-codefly/codefly-cli/pull/18840)
- feat(core): update internal utility models to Codefly 3 by @SandyTao520 in
  [#18773](https://github.com/google-codefly/codefly-cli/pull/18773)
- feat(a2a): add value-resolver for auth credential resolution by @adamfweidman
  in [#18653](https://github.com/google-codefly/codefly-cli/pull/18653)
- Removed getPlainTextLength by @devr0306 in
  [#18848](https://github.com/google-codefly/codefly-cli/pull/18848)
- More grep prompt tweaks by @gundermanc in
  [#18846](https://github.com/google-codefly/codefly-cli/pull/18846)
- refactor(cli): Reactive useSettingsStore hook by @psinha40898 in
  [#14915](https://github.com/google-codefly/codefly-cli/pull/14915)
- fix(mcp): Ensure that stdio MCP server execution has the `CODEFLY_CLI=1` env
  variable populated. by @richieforeman in
  [#18832](https://github.com/google-codefly/codefly-cli/pull/18832)
- fix(core): improve headless mode detection for flags and query args by @galz10
  in [#18855](https://github.com/google-codefly/codefly-cli/pull/18855)
- refactor(cli): simplify UI and remove legacy inline tool confirmation logic by
  @abhipatel12 in
  [#18566](https://github.com/google-codefly/codefly-cli/pull/18566)
...
- refactor: use `CoreToolCallStatus` in the the history data model by @jerop in
  [#19033](https://github.com/google-codefly/codefly-cli/pull/19033)
- feat(cleanup): enable 30-day session retention by default by @skeshive in
  [#18854](https://github.com/google-codefly/codefly-cli/pull/18854)
- feat(plan): hide plan write and edit operations on plans in Plan Mode by
  @jerop in [#19012](https://github.com/google-codefly/codefly-cli/pull/19012)
- bug(ui) fix flicker refreshing background color by @jacob314 in
  [#19041](https://github.com/google-codefly/codefly-cli/pull/19041)
- chore: fix dep vulnerabilities by @scidomino in
  [#19036](https://github.com/google-codefly/codefly-cli/pull/19036)
- Revamp automated changelog skill by @g-samroberts in
  [#18974](https://github.com/google-codefly/codefly-cli/pull/18974)
- feat(sdk): implement support for custom skills by @mbleigh in
  [#19031](https://github.com/google-codefly/codefly-cli/pull/19031)
- refactor(core): complete centralization of core tool definitions by
  @aishaneeshah in
  [#18991](https://github.com/google-codefly/codefly-cli/pull/18991)
- feat: add /commands reload to refresh custom TOML commands by @korade-krushna
  in [#19078](https://github.com/google-codefly/codefly-cli/pull/19078)
...
- fix(core): Encourage non-interactive flags for scaffolding commands by
  @NTaylorMullen in
  [#18804](https://github.com/google-codefly/codefly-cli/pull/18804)
- fix(core): propagate User-Agent header to setup-phase CodeAssist API calls by
  @gsquared94 in
  [#19182](https://github.com/google-codefly/codefly-cli/pull/19182)
- docs: document .agents/skills alias and discovery precedence by @kevmoo in
  [#19166](https://github.com/google-codefly/codefly-cli/pull/19166)
- feat(cli): add loading state to new agents notification by @sehoon38 in
  [#19190](https://github.com/google-codefly/codefly-cli/pull/19190)
- Add base branch to workflow. by @g-samroberts in
  [#19189](https://github.com/google-codefly/codefly-cli/pull/19189)
- feat(cli): handle invalid model names in useQuotaAndFallback by @sehoon38 in
  [#19222](https://github.com/google-codefly/codefly-cli/pull/19222)
- docs: custom themes in extensions by @jackwotherspoon in
  [#19219](https://github.com/google-codefly/codefly-cli/pull/19219)
...
- refactor: consolidate development rules and add cli guidelines by @jacob314 in
  [#19214](https://github.com/google-codefly/codefly-cli/pull/19214)
- chore(ui): remove outdated tip about model routing by @sehoon38 in
  [#19226](https://github.com/google-codefly/codefly-cli/pull/19226)
- feat(core): support custom reasoning models by default by @NTaylorMullen in
  [#19227](https://github.com/google-codefly/codefly-cli/pull/19227)
- Add Solarized Dark and Solarized Light themes by @rmedranollamas in
  [#19064](https://github.com/google-codefly/codefly-cli/pull/19064)
- fix(telemetry): replace JSON.stringify with safeJsonStringify in file
  exporters by @gsquared94 in
  [#19244](https://github.com/google-codefly/codefly-cli/pull/19244)
- feat(telemetry): add keychain availability and token storage metrics by
  @abhipatel12 in
  [#18971](https://github.com/google-codefly/codefly-cli/pull/18971)
- feat(cli): update approval mode cycle order by @jerop in
  [#19254](https://github.com/google-codefly/codefly-cli/pull/19254)
- refactor(cli): code review cleanup fix for tab+tab by @jacob314 in
  [#18967](https://github.com/google-codefly/codefly-cli/pull/18967)
...
- Fix side breakage where anchors don't work in slugs. by @g-samroberts in
  [#19261](https://github.com/google-codefly/codefly-cli/pull/19261)
- feat(config): add setting to make directory tree context configurable by
  @kevin-ramdass in
  [#19053](https://github.com/google-codefly/codefly-cli/pull/19053)
- fix(acp): Wait for mcp initialization in acp (#18893) by @Mervap in
  [#18894](https://github.com/google-codefly/codefly-cli/pull/18894)
- docs: format UTC times in releases doc by @pavan-sh in
  [#18169](https://github.com/google-codefly/codefly-cli/pull/18169)
- Docs: Clarify extensions documentation. by @jkcinouye in
  [#19277](https://github.com/google-codefly/codefly-cli/pull/19277)
- refactor(core): modularize tool definitions by model family by @aishaneeshah
  in [#19269](https://github.com/google-codefly/codefly-cli/pull/19269)
- fix(paths): Add cross-platform path normalization by @spencer426 in
  [#18939](https://github.com/google-codefly/codefly-cli/pull/18939)
- feat(core): experimental in-progress steering hints (1 of 3) by @joshualitt in
  [#19008](https://github.com/google-codefly/codefly-cli/pull/19008)

**Full changelog**:
https://github.com/google-codefly/codefly-cli/compare/v0.29.0-preview.5...v0.30.0-preview.5
