...
- **Codefly 3 by Default:** Codefly 3 is now the default model family, bringing
...
- Add support for /extensions config command by @chrstnb in
  [#17895](https://github.com/google-codefly/codefly-cli/pull/17895)
- fix(core): handle non-compliant mcpbridge responses from Xcode 26.3 by
  @peterfriese in
  [#18376](https://github.com/google-codefly/codefly-cli/pull/18376)
- feat(cli): Add W, B, E Vim motions and operator support by @ademuri in
  [#16209](https://github.com/google-codefly/codefly-cli/pull/16209)
- fix: Windows Specific Agent Quality & System Prompt by @scidomino in
  [#18351](https://github.com/google-codefly/codefly-cli/pull/18351)
- feat(plan): support `replace` tool in plan mode to edit plans by @jerop in
  [#18379](https://github.com/google-codefly/codefly-cli/pull/18379)
- Improving memory tool instructions and eval testing by @alisa-alisa in
  [#18091](https://github.com/google-codefly/codefly-cli/pull/18091)
- fix(cli): color extension link success message green by @MushuEE in
  [#18386](https://github.com/google-codefly/codefly-cli/pull/18386)
- undo by @jacob314 in
...
- feat(plan): integrate planning artifacts and tools into primary workflows by
  @jerop in [#18375](https://github.com/google-codefly/codefly-cli/pull/18375)
- Fix permission check by @scidomino in
  [#18395](https://github.com/google-codefly/codefly-cli/pull/18395)
...
- feat(plan): implement support for MCP servers in Plan mode by @Adib234 in
  [#18229](https://github.com/google-codefly/codefly-cli/pull/18229)
- chore: update folder trust error messaging by @galz10 in
  [#18402](https://github.com/google-codefly/codefly-cli/pull/18402)
- feat(plan): create a metric for execution of plans generated in plan mode by
  @Adib234 in [#18236](https://github.com/google-codefly/codefly-cli/pull/18236)
- perf(ui): optimize stripUnsafeCharacters with regex by @gsquared94 in
  [#18413](https://github.com/google-codefly/codefly-cli/pull/18413)
- feat(context): implement observation masking for tool outputs by @abhipatel12
  in [#18389](https://github.com/google-codefly/codefly-cli/pull/18389)
- feat(core,cli): implement session-linked tool output storage and cleanup by
  @abhipatel12 in
  [#18416](https://github.com/google-codefly/codefly-cli/pull/18416)
- Shorten temp directory by @joshualitt in
  [#17901](https://github.com/google-codefly/codefly-cli/pull/17901)
- feat(plan): add behavioral evals for plan mode by @jerop in
  [#18437](https://github.com/google-codefly/codefly-cli/pull/18437)
- Add extension registry client by @chrstnb in
  [#18396](https://github.com/google-codefly/codefly-cli/pull/18396)
- Enable extension config by default by @chrstnb in
  [#18447](https://github.com/google-codefly/codefly-cli/pull/18447)
- Automatically generate change logs on release by @g-samroberts in
  [#18401](https://github.com/google-codefly/codefly-cli/pull/18401)
...
- Added "" as default value, since getText() used to expect a string only and
  ...
  [#18099](https://github.com/google-codefly/codefly-cli/pull/18099)
- Allow @-includes outside of workspaces (with permission) by @scidomino in
  [#18470](https://github.com/google-codefly/codefly-cli/pull/18470)
- chore: make `ask_user` header description more clear by @jackwotherspoon in
  [#18657](https://github.com/google-codefly/codefly-cli/pull/18657)
- refactor(core): model-dependent tool definitions by @aishaneeshah in
  [#18563](https://github.com/google-codefly/codefly-cli/pull/18563)
- Harded code assist converter. by @jacob314 in
  [#18656](https://github.com/google-codefly/codefly-cli/pull/18656)
- bug(core): Fix minor bug in migration logic. by @joshualitt in
  [#18661](https://github.com/google-codefly/codefly-cli/pull/18661)
- feat: enable plan mode experiment in settings by @jerop in
  [#18636](https://github.com/google-codefly/codefly-cli/pull/18636)
- refactor: push isValidPath() into parsePastedPaths() by @scidomino in
  [#18664](https://github.com/google-codefly/codefly-cli/pull/18664)
- fix(cli): correct 'esc to cancel' position and restore duration display by
  @NTaylorMullen in
  [#18534](https://github.com/google-codefly/codefly-cli/pull/18534)
- feat(cli): add DevTools integration with codefly-cli-devtools by @SandyTao520
  in [#18648](https://github.com/google-codefly/codefly-cli/pull/18648)
- chore: remove unused exports and redundant hook files by @SandyTao520 in
  [#18681](https://github.com/google-codefly/codefly-cli/pull/18681)
- Fix number of lines being reported in rewind confirmation dialog by @Adib234
  in [#18675](https://github.com/google-codefly/codefly-cli/pull/18675)
- feat(cli): disable folder trust in headless mode by @galz10 in
  [#18407](https://github.com/google-codefly/codefly-cli/pull/18407)
- Disallow unsafe type assertions by @gundermanc in
  [#18688](https://github.com/google-codefly/codefly-cli/pull/18688)
- Change event type for release by @g-samroberts in
  [#18693](https://github.com/google-codefly/codefly-cli/pull/18693)
- feat: handle multiple dynamic context filenames in system prompt by
  @NTaylorMullen in
  [#18598](https://github.com/google-codefly/codefly-cli/pull/18598)
- Properly parse at-commands with narrow non-breaking spaces by @scidomino in
  [#18677](https://github.com/google-codefly/codefly-cli/pull/18677)
- refactor(core): centralize core tool definitions and support model-specific
  schemas by @aishaneeshah in
  [#18662](https://github.com/google-codefly/codefly-cli/pull/18662)
- feat(core): Render memory hierarchically in context. by @joshualitt in
  [#18350](https://github.com/google-codefly/codefly-cli/pull/18350)
- feat: Ctrl+O to expand paste placeholder by @jackwotherspoon in
  [#18103](https://github.com/google-codefly/codefly-cli/pull/18103)
- fix(cli): Improve header spacing by @NTaylorMullen in
  [#18531](https://github.com/google-codefly/codefly-cli/pull/18531)
- Feature/quota visibility 16795 by @spencer426 in
  [#18203](https://github.com/google-codefly/codefly-cli/pull/18203)
- Inline thinking bubbles with summary/full modes by @LyalinDotCom in
  [#18033](https://github.com/google-codefly/codefly-cli/pull/18033)
- docs: remove TOC marker from Plan Mode header by @jerop in
  [#18678](https://github.com/google-codefly/codefly-cli/pull/18678)
- fix(ui): remove redundant newlines in Codefly messages by @NTaylorMullen in
  [#18538](https://github.com/google-codefly/codefly-cli/pull/18538)
- test(cli): fix AppContainer act() warnings and improve waitFor resilience by
  @NTaylorMullen in
  [#18676](https://github.com/google-codefly/codefly-cli/pull/18676)
- refactor(core): refine Security & System Integrity section in system prompt by
  @NTaylorMullen in
  [#18601](https://github.com/google-codefly/codefly-cli/pull/18601)
- Fix layout rounding. by @gundermanc in
  [#18667](https://github.com/google-codefly/codefly-cli/pull/18667)
- docs(skills): enhance pr-creator safety and interactivity by @NTaylorMullen in
  [#18616](https://github.com/google-codefly/codefly-cli/pull/18616)
- test(core): remove hardcoded model from TestRig by @NTaylorMullen in
  [#18710](https://github.com/google-codefly/codefly-cli/pull/18710)
- feat(core): optimize sub-agents system prompt intro by @NTaylorMullen in
  [#18608](https://github.com/google-codefly/codefly-cli/pull/18608)
- feat(cli): update approval mode labels and shortcuts per latest UX spec by
  @jerop in [#18698](https://github.com/google-codefly/codefly-cli/pull/18698)
...
- fix(core): standardize tool formatting in system prompts by @NTaylorMullen in
  [#18615](https://github.com/google-codefly/codefly-cli/pull/18615)
- chore: consolidate to green in ask user dialog by @jackwotherspoon in
  [#18734](https://github.com/google-codefly/codefly-cli/pull/18734)
- feat: add `extensionsExplore` setting to enable extensions explore UI. by
  @sripasg in [#18686](https://github.com/google-codefly/codefly-cli/pull/18686)
- feat(cli): defer devtools startup and integrate with F12 by @SandyTao520 in
  [#18695](https://github.com/google-codefly/codefly-cli/pull/18695)
- ui: update & subdue footer colors and animate progress indicator by
  @keithguerin in
  [#18570](https://github.com/google-codefly/codefly-cli/pull/18570)
- test: add model-specific snapshots for coreTools by @aishaneeshah in
  [#18707](https://github.com/google-codefly/codefly-cli/pull/18707)
- ci: shard windows tests and fix event listener leaks by @NTaylorMullen in
  [#18670](https://github.com/google-codefly/codefly-cli/pull/18670)
- fix: allow `ask_user` tool in yolo mode by @jackwotherspoon in
  [#18541](https://github.com/google-codefly/codefly-cli/pull/18541)
- feat: redact disabled tools from system prompt (#13597) by @NTaylorMullen in
  [#18613](https://github.com/google-codefly/codefly-cli/pull/18613)
- Update Codefly.md to use the curent year on creating new files by @sehoon38 in
  [#18460](https://github.com/google-codefly/codefly-cli/pull/18460)
- Code review cleanup for thinking display by @jacob314 in
  [#18720](https://github.com/google-codefly/codefly-cli/pull/18720)
- fix(cli): hide scrollbars when in alternate buffer copy mode by @werdnum in
  [#18354](https://github.com/google-codefly/codefly-cli/pull/18354)
...
- Fix issue where Codefly CLI creates tests in a new file by @gundermanc in
  [#18409](https://github.com/google-codefly/codefly-cli/pull/18409)
- feat(telemetry): Ensure experiment IDs are included in OpenTelemetry logs by
  @kevin-ramdass in
  [#18747](https://github.com/google-codefly/codefly-cli/pull/18747)
- fix(patch): cherry-pick e9a9474 to release/v0.29.0-preview.0-pr-18840 to patch
  ...
  @codefly-cli-robot in
  [#18841](https://github.com/google-codefly/codefly-cli/pull/18841)
- fix(patch): cherry-pick 08e8eea to release/v0.29.0-preview.1-pr-18855 to patch
  ...
  @codefly-cli-robot in
  [#18905](https://github.com/google-codefly/codefly-cli/pull/18905)
- fix(patch): cherry-pick d0c6a56 to release/v0.29.0-preview.2-pr-18976 to patch
  ...
  @codefly-cli-robot in
  [#19023](https://github.com/google-codefly/codefly-cli/pull/19023)
- fix(patch): cherry-pick e5ff202 to release/v0.29.0-preview.3-pr-19254 to patch
  ...
  @codefly-cli-robot in
  [#19264](https://github.com/google-codefly/codefly-cli/pull/19264)
- fix(patch): cherry-pick 9590a09 to release/v0.29.0-preview.4-pr-18771 to patch
  ...
  @codefly-cli-robot in
  [#19274](https://github.com/google-codefly/codefly-cli/pull/19274)

**Full Changelog**:
https://github.com/google-codefly/codefly-cli/compare/v0.28.2...v0.29.0
